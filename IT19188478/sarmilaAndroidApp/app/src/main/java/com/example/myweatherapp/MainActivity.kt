...
class MainActivity : AppCompatActivity() {
    val CITY: String="Jaffna,LK"
    val API:String="a35c45cfa7e35b7e8ff82d60b5cc18c5"
// dhaka,bd
    ...
    inner class weatherTask():AsyncTask<String,Void,String>(){
        ...
        override fun doInBackground(vararg p0: String?): String? {
            var reponse:String?
            try{
                reponse=URL("https://api.openweathermap.org/data/2.5/weather?q=$CITY&units=metric&appid=$API")
